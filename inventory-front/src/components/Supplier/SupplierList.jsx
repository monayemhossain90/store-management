...
import {selectSupplierList, selectSupplierListTotal} from "../../redux/state-slice/supplierSlice";
import {DeleteSupplierRequest, SupplierListRequest} from "../../ApiServices/SupplierApiRequest";
...
const SupplierList = () => {
    ...
    let DataList=useSelector(selectSupplierList);
    let Total=useSelector(selectSupplierListTotal);
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <Link to={`/SupplierUpdatePage/${item._id}`} className="btn text-info btn-outline-light p-2 mb-0 btn-sm">
