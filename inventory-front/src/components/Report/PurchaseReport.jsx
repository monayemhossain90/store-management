...
import {selectPurchaseByDateList} from "../../redux/state-slice/reportSlice";
import {PurchaseByDateRequest} from "../../ApiServices/ReportApiRequest";

const PurchaseReport = () => {
    let fromRef,toRef=useRef();
    let DataList=useSelector(selectPurchaseByDateList);
    ...
    const CreateReport = async () => {
        ...
        if (IsEmpty(fromDate)) {
            ...
            await PurchaseByDateRequest(fromDate,toDate);
        }
    }
