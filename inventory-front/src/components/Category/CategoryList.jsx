...
import {CategoryListRequest, DeleteCategoryRequest} from "../../ApiServices/CategoryApiRequest";
import {selectCategoryList, selectCategoryListTotal} from "../../redux/state-slice/categoryslice";
                                                    ...
                                                    <tbody>
                                                        {
                                                            DataList.map((item,i)=>
                                                                <tr key={i.toString()}>
                                                                    ...
                                                                    <td>
                                                                        <Link to={`/CategoryUpdatePage/${item._id}`} className="btn text-info btn-outline-light p-2 mb-0 btn-sm">
