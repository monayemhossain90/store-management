...
import {selectBrandList, selectBrandListTotal} from "../../redux/state-slice/brandSlice";
...
const BrandList = () => {
    ...
    let DataList=useSelector(selectBrandList);
    let Total=useSelector(selectBrandListTotal)
