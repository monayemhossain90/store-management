...
import {PurchaseListRequest, PurchasesDeleteRequest} from "../../ApiServices/PurchaseApiRequest";
import {selectPurchaseList, selectPurchaseListTotal} from "../../redux/state-slice/purchaseSlice";
...
const PurchaseList = () => {
    ...
    let DataList=useSelector(selectPurchaseList);
    let Total=useSelector(selectPurchaseListTotal)
    ...
    const DeleteItem = async (id) => {
        ...
        if(Result.isConfirmed ===true){
            let DeleteResult= await PurchasesDeleteRequest(id);
                                                ...
                                                <table className="table ">
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr key={i.toString()}>
                                                                <td>
                                                                    <p className="text-xs text-start">{item.SupplierName}</p>
                                                                </td>
